...
-define(ACTIVATE_PAYLOAD, 16#48).
-define(DEACTIVATE_PAYLOAD, 16#49).
-define(GET_PAYLOAD_ACTIVATION_STATUS, 16#4a).
-define(GET_PAYLOAD_INSTANCE_INFO, 16#4b).
-define(GET_CHANNEL_PAYLOAD_SUPPORT, 16#4e).
-define(GET_CHANNEL_PAYLOAD_VERSION, 16#4f).
%% mandatory
